 ...
 * * (e.g., for Sudoku, we could use Strings such as "A3", "B8", etc. to name
squares of the 9x9 board.)
...
public interface CSPProblem<X,V> {
    ...
    /**
     * @return a list of variables that have already been assigned values as part
    of the problem.
     */
    List<X> getAssigned();
}
